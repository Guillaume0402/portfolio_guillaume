                                ...
                                <div class="card-body">
                                    <div class="card-top">
                                        ...
                                        <div class="card-media">
                                            <img class="card-img" loading="lazy" src="" alt="">
                                        </div>
                                ...
                                <div class="btn-projects">
                                    <?php if (!empty($project['github_link'])): ?>
                                        <div class="card-actions">
                                            <a class="card-link" href="" aria-label="Voir le github du projet " target="_blank" rel="noopener noreferrer">Github</a>
                                        </div>
                                    <?php endif; ?>
                                    <?php if (!empty($project['project_link'])): ?>
                                        <div class="card-actions">
                                            <a class="card-link" href="" aria-label="Voir le projet " target="_blank" rel="noopener noreferrer">Voir le projet</a>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </article>
